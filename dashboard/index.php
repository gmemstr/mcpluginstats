  ...
  <body>
    ...
    <div class="container">
      ...
      try {
        		...
        		foreach ($dbh->query("SELECT * FROM `plugins` WHERE `user` = '" . User::current()->user_id . "'") as $row) {
        	    	echo '<div class="row">
         ...
         <div class="panel-heading">
            ...
            <div class="panel-footer">
               <span class="pull-left">
				   '.$row["description"].'<br />
           Online: '.$row["srvnum"].'<br>
           <a href="moreinfo.php?key='.$row["api_key"].'">More info</a></span>
    ...
    ?>
      <a href="new.php" class="btn btn-info" role="button">New Plugin</a>
   	</div>
	</div>
